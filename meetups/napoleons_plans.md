...
* ждём обратной связи от куратора для оценки проделанной задачи, постановки и обсуждения новых

# Спринт 5: до 11.03
Встреча 04.03 состоялась. <br />
* работа по парсингу словарей (глагольная индексация) завершена более, чем на половину
* необходимо подготовить презентацию промежуточных результатов для НИСа
* обратной связи от куратора по-прежнему нет, ждём ответа, подключаем административный ресурс

# Спринт 6: до ???
Встреча 11.03 состоялась. <br />
* презентация для НИСа готова
* в эфире мёртвая тишина
